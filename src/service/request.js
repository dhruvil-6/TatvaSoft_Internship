...
// Request interceptors Customize it based on your need
...
// Response interceptors Customize it based on your need
request.interceptors.response.use(
  (response) => {
    ...
    if (data?.code && data?.code !== 200) {
      toast.error(
        response.data.error ?? "Oops!!! Something went wrong! Please try again!"
      );
